function addMealKitValidation (title, include, description, category, price, cookingTime, serving, topMeal,customerRating, image_ext){
    ...
    if (image_ext.trim().length != 0){
        ...
        passedValidation = false
        validationMessages.image = "your image file should be uploaded'"        
    }
    return {passedValidation, validationMessages}
}
module.exports = addMealKitValidation